...
func main() {
	remoteAPIURL := "https://www.ecologicliving.com/Labels-And-SDS.aspx" // URL to fetch HTML content from
	localFilePath := "ecologicliving.html"                               // Path where HTML file will be stored
...
// fixURL takes an invalid or relative URL and returns a valid absolute URL string.
// If the URL is protocol-relative (starts with //), it prepends "https:".
